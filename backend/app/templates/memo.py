...
MANIFEST = {
    ...
    "worker_instructions": (
        ...
        "『探して本文に入れて/調べてメモに記入』は、Web検索結果を短く要約して本文に反映する。"
        "『メモを作って本文に〜を書いて』『新しいメモを作って調査結果を入れて』のような複合命令は、"
        "メモ作成と本文更新/追記に分けて処理する。現在開いているメモが一意なら対象として使う。"
        "断片的な本文依頼はそのまま転記せず、『持っていくもの: ノート』『確認事項: 集合時間』のように整理する。"
        "削除や更新で対象タイトルが不明なら、どのメモか聞き返す。"
    ),
    "worker_examples": [
        {"user": "買い物メモを作って", "command": {"name": "add_note", "arguments": {"title": "買い物", "body": ""}}, "reply": "メモを作成します。"},
        {"user": "仙台出張メモを作って、本文に持ち物と確認事項を書いて", "command": {"name": "add_note", "arguments": {"title": "仙台出張", "body": "持ち物と確認事項を整理して記入する"}}, "reply": "メモを作成し、本文も記入します。"},
        {"user": "牛乳も追記して", "command": {"name": "append_note", "arguments": {"text": "牛乳"}}, "reply": "現在のメモに追記します。"},
        {"user": "持っていくものとしてノートを追記して", "command": {"name": "append_note", "arguments": {"text": "持っていくもの: ノート"}}, "reply": "現在のメモに整理して追記します。"},
        {"user": "仙台駅近くの仙台名物の食事処を3つ探して本文に記入して", "command": {"name": "append_note", "arguments": {"text": "Web検索結果を3件に要約して記入する"}}, "reply": "検索結果を要約して本文に記入します。"},
